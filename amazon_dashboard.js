...
const STR={
  annual:['연간','Annual'], quarter:['분기','Quarter'], monthly:['월간','Monthly'], weekly:['주간','Weekly'], daily:['일간','Daily'], ads:['광고','Ads'], salesMode:['매출','Sales'], adsMode:['광고','Ads'], overview:['개요','Overview'], keyword:['키워드','Keywords'],
...
function render(){
  ...
  if(appMode==='ads'){
    ...
    if(activeTab==='keyword') renderKeywords();
    else renderAds();
    return;
  }
...
const ADS_TABS=['overview','keyword'];   // 확장: 여기에 탭 추가
